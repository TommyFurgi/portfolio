...
const CustomIcon = () => (
  ...
  >
    <defs>
      <linearGradient id="IconifyId17ecdb2904d178eab5755" x1="1609.9" x2="1726.5" y1="-1536.9" y2="-1536.9" gradientTransform="matrix(.0021 -1 -1 -.0021 -1476.4 1729)" gradientUnits="userSpaceOnUse">
    ...
    />
    <path
      d="M68.64 74.29l.46 21.16l-2.45-1.7c-.59 0-1.04-.77-.97-1.65l.77-17.84c.14-1.77 2.1-1.75 2.19.03z"
      fill="#EDA600"
    />
    <path
      d="M84.8 49.27l2.81 6.97l.94 2.47l-3.32-.87L82 56.9l.09-7.48c-.01-1.38 2.15-1.24 2.71-.15z"
      fill="#EDA600"
    />
    <path
      d="M51.53 73.89l.77 13.07c.05.59-2.52.25-2.52.25c-.59 0-1.04-.53-.97-1.13l.77-12.23c.13-1.21 1.85-1.18 1.95.04z"
      fill="#EDA600"
    />
    <path
      d="M34.9 74.12l.77 7.04c.05.32-2.52.13-2.52.13c-.59 0-1.04-.28-.97-.61l.77-6.58c.14-.65 1.86-.63 1.95.02z"
      fill="#EDA600"
    />
  </svg>
);
